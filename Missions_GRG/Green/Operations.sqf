...
_missionPatrolVehicles = [
     // I leave this blank unless you want something very specific 
     // Sometiems you need the spawn points further away from mission center than what is used normally.
     // Then, it is good to place vehicles in the editor and use those spawn points.
