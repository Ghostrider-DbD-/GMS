/*
	blck_fnc_spawnMissionLootVehicles 
...
private _vehs = [];
{
	...
	if (_loadCrateTiming isEqualTo "atMissionSpawnGround") then
	{
		...
		[format["blck_fnc_spawnMissionLootVehicles (29) _crateMoney = %1",_crateMoney]] call blck_fnc_log;		
		//[_veh,missionNamespace getVariable (format["blck_crateMoney%1",_difficulty])] call GMS_fnc_setMoney;
	} else {
