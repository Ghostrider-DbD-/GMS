...
if (blck_debugLevel > 2) then {diag_log format["DLS Diagnostics:: Worldname is %1",_worldName];};
...
if (_worldName isEqualTo "altis") then
	...
	*/
	...
	diag_log "DLS_triggers_Epoch:: configurations loaded for Altis as of 6-19-16";
	//diag_log format["DLS_triggers_Epoch:: DSL_Spawn_Locations = %1",DLS_Spawn_Locations];
};  
...
diag_log format["DLS Triggers for Epoch Loaded. locations list = %1",DLS_Spawn_Locations];
