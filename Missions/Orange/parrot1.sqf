...
_startMsg = "Never mind that, my lad. I wish to complain about this parrot what I purchased not half an hour ago from this very boutique. (BLACK/HARDEST)";
_endMsg = "Look, matey, I know a dead parrot when I see one, and I'm looking at one right now. (MISSION SUCCESS)";
_timeoutMsg = "Dead Parrot sketch was too silly, and has moved on. (MISSION FAILED)";
_showMarker = true;
_markerType = ["ELLIPSE",[750,750],"SOLID"];
_markerColor = "ColorBlack";


_markerMissionName = "Operation Dead Parrot";
/*
...
_missionLandscape = [
     ...
     ["Land_Offices_01_V1_F",[24.6836,-9.94678,0],[[0,1,0],[0,0,1]],[true,true]],
     ["Land_Offices_01_V1_F",[60.6758,-9.99219,0],[[0,1,0],[0,0,1]],[true,true]],
     ["Land_MultistoryBuilding_01_F",[108.909,-53.8032,0],[[0.999943,0.010696,0],[0,0,1]],[true,true]],
     ["Land_Offices_01_V1_F",[23.7969,-67.937,0],[[0.00308075,-0.999995,0],[0,0,1]],[true,true]],
     ["Land_Offices_01_V1_F",[59.9224,-67.9063,0],[[0.00308075,-0.999995,0],[0,0,1]],[true,true]],
     ["RoadCone_F",[46.75,-40.2227,0],[[0,1,0],[0,0,1]],[true,true]],
     ["I_CargoNet_01_ammo_F",[13.3462,-15.3967,17.852],[[0,1,0],[0,0,1]],[true,true]],
     ["I_CargoNet_01_ammo_F",[59.9497,-7.66479,17.852],[[0,1,0],[0,0,1]],[true,true]]
];
...
_missionPatrolVehicles = [
     ["CUP_B_FV510_GB_D",[105.25,-16.6223,0],0],
     ["CUP_B_FV510_GB_D",[60.9033,-137.998,0],0]
];
...
_airPatrols = [
     ["CUP_B_UH1Y_Gunship_Dynamic_USMC",[167.344,-25.8074,0],0],
     ["CUP_B_UH1Y_Gunship_Dynamic_USMC",[-22.7207,-32.5791,0],0],
...
_missionEmplacedWeapons = [
     ...
     ["B_G_Mortar_01_F", [120.246,-73.1606,40.2844], [[0,1,0],[0,0,1]], "Orange"],
     ["B_G_Mortar_01_F", [97.9058,-73.4788,40.2844], [[0,1,0],[0,0,1]], "Orange"],
     ["B_G_Mortar_01_F", [98.7188,-41.302,40.2844], [[0,1,0],[0,0,1]], "Orange"],
     ["B_G_Mortar_01_F", [118.61,-40.7869,40.2844], [[0,1,0],[0,0,1]], "Orange"],
     ["B_G_Mortar_01_F", [69.5796,-68.0093,17.8518], [[0,1,0],[0,0,1]], "Orange"],
     ["B_G_Mortar_01_F", [50.5073,-9.66968,17.8518], [[0,1,0],[0,0,1]], "Orange"],
     ["B_G_Mortar_01_F", [13.8882,-9.98291,17.8517], [[0,1,0],[0,0,1]], "Orange"],
     ["B_Mortar_01_F", [33.3223,-68.178,17.8518], [[0,1,0],[0,0,1]], "Orange"],
     ["B_HMG_01_high_F", [35.4229,-13.49,12.6394], [[0,1,0],[0,0,1]], "Orange"],
     ["B_HMG_01_high_F", [71.3955,-13.3445,12.6394], [[0,1,0],[0,0,1]], "Orange"],
     ["B_GMG_01_high_F", [13.083,-64.134,12.6394], [[0,1,0],[0,0,1]], "Orange"],
     ["B_GMG_01_high_F", [49.2085,-64.6804,12.6394], [[0,1,0],[0,0,1]], "Orange"],
     ["B_HMG_01_high_F", [54.7554,-66.3149,4.81364], [[0,1,0],[0.000488281,0,1]], "Orange"],
     ["B_HMG_01_high_F", [13.1753,-74.1201,0.915001], [[0,1,0],[0,0,1]], "Orange"],
     ["B_HMG_01_high_F", [30.0186,-4.47241,0.914999], [[0,1,0],[0,0,1]], "Orange"],
     ["B_HMG_01_high_F", [66.0732,-8.4104,8.81046], [[0,0.999999,0.00119604],[-0.000488281,-0.00119604,0.999999]], "Orange"],
     ["B_GMG_01_high_F", [14.0332,-68.2273,17.8517], [[0,1,0],[0,0,1]], "Orange"],
     ["B_GMG_01_high_F", [60.0098,-72.0439,17.8517], [[0,1,0],[0,0,1]], "Orange"],
     ["B_HMG_01_high_F", [90.4824,-48.0852,8.95394], [[0,1,0],[0.00229024,0,0.999997]], "Orange"],
     ["B_GMG_01_high_F", [91.0132,-39.9353,6.36715], [[0,1,0],[0,0,1]], "Orange"],
     ["B_HMG_01_high_F", [126.246,-35.3955,5.53548], [[0,1,0],[0,0,1]], "Orange"],
     ["B_HMG_01_high_F", [58.332,-57.8779,0], [[0,1,0],[0,0,1]], "Orange"]
];

_missionGroups = [
     [[58.4033,-66.2441,17.8532],1,2,"Orange",30,45],
     [[25.0967,-8.37012,17.8532],1,2,"Orange",30,45],
     [[11.2041,-40.9846,0.00143909],1,2,"Orange",30,45],
     [[74.8325,-39.8899,0.00143909],1,2,"Orange",30,45],
     [[120.087,-1.38843,0.00143909],1,2,"Orange",30,45]
];
...
_missionLootBoxes = [
     ["I_CargoNet_01_ammo_F",[13.3462,-15.3967,17.852],_crateLoot,_lootCounts,[[0,1,0],[0,0,1]]],
     ["I_CargoNet_01_ammo_F",[59.9497,-7.66479,17.852],_crateLoot,_lootCounts,[[0,1,0],[0,0,1]]]
];
