...
_startMsg = "A Special Ops Unit Was Spotted";
_endMsg = "Patriots Captured the Spec Ops Team";
_timeoutMsg = "The Spec Ops Team Vanished Into the Mist";
_markerType = ["ELLIPSE",[150,150],"GRID"];
_markerColor = "ColorGreen";


_markerMissionName = "Spec Ops";
/*
