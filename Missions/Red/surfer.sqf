...
_defaultMissionLocations = [[21323.9,10432.8,-0.0182486]];
...
_startMsg = "Enemy forces spotted on RNR. (RED) ";
_endMsg = "Patriots have given the enemy forces permanent RNR time.";
_timeoutMsg = "Enemy forces on the beach finished their RNR. Missed opportunity.";
_markerType = ["ELLIPSE",[200,200],"GRID"];
_markerColor = "ColorRed";


_markerMissionName = "Surfer Slaughter";
/*
...
_missionLandscape = [
     ["RoadCone_F",[12.3516,-7.92871,0.02741],0,[true,true]]
];
...
_missionEmplacedWeapons = [
     ["B_HMG_01_high_F", [0.283203,0.287109,0.0189738], 0, "Red"],
     ["B_HMG_01_high_F", [15.5215,-43.709,4.1835], 0, "Red"],
     ["B_HMG_01_high_F", [22.0996,-33.7646,0.0221169], 0, "Red"]
];
