...
_startMsg = "A small enemy fortification has been scouted and marked on the map. (Blue/EASY)";
...
_missionGroups = [
     [[-9.48462,10.0234,0.00143909],4,5,"Blue"],
     [[-30.6729,17.834,0.00143909],4,5,"Blue"]
];
