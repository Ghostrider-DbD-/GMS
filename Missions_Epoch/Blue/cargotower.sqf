...
_startMsg = "An enemy cargo tower has been scouted and marked on the map. (Blue/EASY)";
...
_missionEmplacedWeapons = [
    selectRandom [
          ["B_HMG_01_high_F", [-7.2915,-5.89307,0], [[0,1,0],[0,0,1]], "Blue"],
          ["B_HMG_01_high_F", [5.50659,-8.42432,17.8895], [[0,1,0],[0,0,1]], "Blue"]
    ]
];

_missionGroups = [
     [[4.96973,-7.09473,15.3661],1,2,"Blue"],
     [[-17.323,-5.39355,0.00143909],1,3,"Blue"],
     [[27.6199,-7.61963,0.00143909],1,3,"Blue"]
];
