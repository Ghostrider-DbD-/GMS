...
_startMsg = "Enemy forces are stripping down buildings for supplies. (Blue/EASY)";
...
_missionGroups = [
     [[-7.53174,19.2942,0.00143909],4,5,"Blue",30,45],
     [[-5.04932,-22.6379,0.00143909],4,5,"Blue",30,45]
];
