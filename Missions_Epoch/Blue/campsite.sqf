...
_startMsg = "An small enemy campsite has been scouted and marked on the map. (Blue/EASY)";
...
_missionGroups = [
     [[-9.49316,-0.722168,0.00143909],3,5,"Blue"],
     [[18.7739,-1.60059,0.00143909],3,5,"Blue"]
];
