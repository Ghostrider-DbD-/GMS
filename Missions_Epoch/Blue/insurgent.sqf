...
_startMsg = "A small insurgent camp has been scouted and marked on the map. (Blue/EASY)";
...
_missionGroups = [
     [[12.9507,-10.0192,0.00143909],2,3,"Blue"],
     [[3.16333,14.5118,0.00143909],4,5,"Blue"],
     [[-16.0146,-1.60681,0.00143909],3,4,"Blue"]
];
