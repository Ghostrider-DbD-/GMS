...
_startMsg = "A mercenary group has setup a roadblock. Location scouted and marked on map. (Blue/EASY)";
_endMsg = "Mercenary roadblock has been cleared!";
...
_missionGroups = [
     [[-9.59082,-19.4199,0.000736237],3,6,"Blue"],
     [[8.57031,-14.7285,0.000549316],4,5,"Blue"]
];
