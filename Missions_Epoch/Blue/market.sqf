...
_startMsg = "A small market is being attacked by bandits. (Blue/EASY)";
...
_missionEmplacedWeapons = [
     selectRandom [
          ["B_HMG_01_high_F", [13.7891,8.60254,0], [[0,1,0],[0,0,1]], "Blue"],
          ["B_HMG_01_high_F", [-14.9902,36.1138,0], [[0,1,0],[0,0,1]], "Blue"]
     ]
];

_missionGroups = [
     [[42.2136,25.6382,0.00143909],4,5,"Blue"],
     [[-10.564,16.293,0.00143909],3,5,"Blue"]
];
