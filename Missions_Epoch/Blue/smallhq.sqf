...
_startMsg = "Small enemy HQ spotted and marked on the map (Blue/EASY)";
...
_missionEmplacedWeapons = [
     selectRandom [["B_HMG_01_high_F", [1.51611,5.94556,0.503], [[0,1,0],[0,0,1]], "Blue"],
...
_missionGroups = [
     [[-2.37305,20.9843,0.00143909],4,5,"Blue",30,45],
     [[0.109375,-20.9479,0.00143909],4,5,"Blue",30,45]
];
