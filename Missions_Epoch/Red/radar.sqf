...
_startMsg = "Enemy radar complex has been scouted and marked on the map (RED/MEDIUM)";
...
private _emplaced = [
     ...
     ["B_HMG_01_high_F", [24.8818,4.2666,0.18847], [[0,1,0],[0,0,1]], "Red"],
     ["B_GMG_01_high_F", [4.72046,-11.9288,0.18847], [[0,1,0],[0,0,1]], "Red"],
...
_missionGroups = [
     [[20.2891,-0.392212,4.872],3,4,"Red",30,45],
     [[6.59766,-5.70148,1.15641],5,6,"RED",30,45],
     [[25.7705,28.756,0.189909],4,5,"Red",30,45]
];
