...
_startMsg = "Enemy foritifcation has been scouted and marked on the map (RED/MEDIUM)";
...
_missionGroups = [
     [[0.529541,-9.77783,0.00143909],3,4,"Red"],
     [[-11.7542,8.04004,0.00143909],5,6,"Red"],
     [[-33.0359,-7.46338,0.00143909],5,6,"Red"]
];
