...
_groups = [
     [[17.535,9.26514,3.12796],2,3,"RED"],
     [[-13.558,24.0972,3.12796],2,3,"RED"],
     [[3.74072,13.2544,0.00143909],2,3,"RED"],
     [[-3.54211,-13.5405,0.00143909],2,4,"RED"],
     [[32.109,-4.81934,0.00143909],2,3,"RED"],
     [[-12.3046,24.1689,0.603113],2,4,"RED"],
     [[-6.83374,21.272,0.00143909],2,4,"RED"],
     [[4.87683,-6.9248,0.00143909],2,4,"RED"],
     [[-1.02954,26.0737,0.00143909],2,4,"RED"],
     [[-9.27332,9.60596,0.00143909],2,3,"RED"]	 
];
_count = 4;
_missionGroups = [_groups, _count] call GMSCore_fnc_selectRandomCount;
