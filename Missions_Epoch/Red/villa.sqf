...
_startMsg = "Intel suggests bandits have stashed multiple crates in a small villa. (RED/MEDIUM)";
...
private _emplaced = [
     ...
     ["I_HMG_01_high_F", [2.26929,4.12793,10.1144], [[0,0.999966,0.00830071],[-0.0167937,-0.00829954,0.999825]], "Red"]
];
private _count = 2;
...
private _patrols = [
     [[13.4768,-38.9521,4.9781],3,4,"Red"],
     [[5.52563,1.02637,3.86],3,4,"Red"],
     [[-7.8562,8.11572,3.85935],3,4,"Red"],
     [[-33.8962,11.2769,0.327958],3,4,"Red"]
];
_count = 3;
