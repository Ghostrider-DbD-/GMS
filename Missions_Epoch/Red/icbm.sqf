...
_startMsg = "Enemy ICBM Site scouted and marked on the map. (RED/MEDIUM)";
...
_missionEmplacedWeapons = [
     ...
     ["B_HMG_01_high_F", [17.9302,24.3163,0], [[0,1,0],[0,0,1]], "Red"],
     ["B_HMG_01_high_F", [-21.5981,-11.6798,0], [[0,1,0],[0,0,1]], "Red"]
];

_missionGroups = [
     [[41.7607,-49.5333,0.00143909],3,4,"Red"],
     [[-9.12939,-8.4743,0.00143909],5,6,"Red"],
     [[-30.9912,64.3263,0.00143909],5,6,"Red"]
];
