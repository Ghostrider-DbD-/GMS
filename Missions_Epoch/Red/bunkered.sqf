...
_startMsg = "A Mercenary Bunker and outpost has been scouted and marked on the map (RED/MEDIUM)";
...
_missionGroups = [
     [[23.7504,22.7505,0.00143909],4,5,"Red"],
     [[10.1968,-4.25977,0.00143909],4,6,"Red"],
     [[59.5118,4.36279,0.00143909],4,5,"Red"]
];
