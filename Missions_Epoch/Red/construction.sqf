...
_startMsg = "Enemy construction and supplies has been scouted and marked on the map (RED/MEDIUM)";
...
_missionGroups = [
     [[-3.92285,12.6506,0.401291],5,6,"Red"],
     [[3.12744,1.11157,8.37153],3,4,"Red"],
     [[8.59473,-18.2095,0.00143909],5,6,"Red"]
];
