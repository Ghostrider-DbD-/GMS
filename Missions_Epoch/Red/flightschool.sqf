...
_startMsg = "An enemy flight school is in session... we hear their training planes are UNARMED! LOL! (RED/MEDIUM)";
...
_missionGroups = [
     [[-0.29834,0.533691,0.504438],6,8,"Red"],
     [[-2.87402,23.5664,0.00143909],7,8,"Red"]
];
