...
_startMsg = "An Enemy field radar has been scouted and marked on the map (RED/MEDIUM)";
...
_missionGroups = [
     [[12.4797,12.6411,0.00243902],5,6,"Red"],
     [[-15.7996,45.3403,0.00243902],5,6,"Red"],
     [[22.2156,45.5718,0.00243902],3,4,"Red"]
];
