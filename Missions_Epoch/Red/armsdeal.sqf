...
_startMsg = "Intel suggests bandit factions are brokering an arms deal involving MULTIPLE crates. (RED/MEDIUM)";
...
_missionPatrolVehicles = [
     [selectRandom GMS_AIPatrolVehiclesRed,[-44.6853,-10.5591,0.00156975],0],
     [selectRandom GMS_AIPatrolVehiclesRed,[15.5256,-13.8643,0],0]
];
...
private _emplaced =  [
     ...
     ["B_HMG_01_high_F", [-18.2595,-20.4263,0.00122976], [[0,1,0],[0,0,1]], "Red"],
     ["B_HMG_01_high_F", [6.46436,5.70313,0], [[0,1,0],[0,0,1]], "Red"]     
];
_missionEmplacedWeapons = [_emplaced, _count] call GMSCore_fnc_selectRandomCount;

_missionGroups = [
     [[-0.256104,0.760254,3.86108],3,4,"Red"],
     [[-28.1265,-20.79,3.21523],3,4,"Red"],
     [[-2.73926,-27.1772,0.00143909],3,4,"Red"],
     [[-39.3557,9.00439,0.00143909],3,4,"Red"]
];
