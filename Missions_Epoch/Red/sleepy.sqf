...
_startMsg = "Enemy outpost has been scouted and marked on the map (RED/MEDIUM)";
...
_missionEmplacedWeapons = [_emplaced, _count] call GMSCore_fnc_selectRandomCount;

private _patrols = [
     [[17.535,9.26514,3.12796],4,5,"Red",30,45],
     [[-13.558,24.0972,3.12796],4,5,"Red",30,45],
     [[3.74072,13.2544,0.00143909],4,5,"Red",30,45],
     [[-3.54211,-13.5405,0.00143909],4,5,"RED"],
     [[22.109,-4.81934,0.00143909],4,5,"Red",30,45],
     [[-12.3046,24.1689,0.603113],3,4,"RED"],
     [[-6.83374,21.272,0.00143909],3,4,"RED"],
     [[4.87683,-6.9248,0.00143909],3,4,"RED"],
     [[-1.02954,26.0737,0.00143909],3,4,"RED"],
     [[-9.27332,9.60596,0.00143909],3,4,"RED"]
];
_count = 3;
_missionGroups = [_patrols, _count] call GMSCore_fnc_selectRandomCount;
