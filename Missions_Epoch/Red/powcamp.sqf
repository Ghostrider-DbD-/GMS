...
_startMsg = "Enemy POW camp scouted and marked on the map (RED/MEDIUM)";
...
private _emplaced = [
     ["B_HMG_01_high_F", [-34.4719,28.0991,20.5729], 0, "Red"],
     ["B_HMG_01_high_F", [25.7141,-32.4048,20.515], 0, "Red"],
     ["B_HMG_01_high_F", [-7.37158,-5.84521,4.34405], 0, "Red"],
     ["B_GMG_01_high_F", [20.5212,-2.93018,0], 0, "Red"]
];
private _count = 2;
...
_missionGroups = [
     [[-2.44092,13.9883,0.00143909],3,4,"Red"],
     [[9.85303,-15.8623,0.00143909],4,5,"Red"],
     [[-12.5906,-51.6309,0.00143909],4,6,"Red"]
];
