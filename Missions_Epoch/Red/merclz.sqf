...
_startMsg = "A Mercenary LZ has been scouted and marked on the map (RED/MEDIUM)";
...
_missionGroups = [
     [[30.2893,56.9409,0.00143909],3,4,"Red"],
     [[17.0474,24.2617,0.00143909],5,6,"Red"],
     [[-13.1365,-9.83887,0.00143909],5,6,"Red"]
];
