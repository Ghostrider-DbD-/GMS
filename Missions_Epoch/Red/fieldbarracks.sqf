...
_startMsg = "An Enemy field barracks has been scouted and marked on the map (RED/MEDIUM)";
...
_missionGroups = [
     [[-21.6536,13.6816,0.00143909],5,5,"Red"],
     [[-19.6707,-5.77148,0.114583],5,6,"Red"],
     [[-4.99463,3.2334,0.00143909],3,6,"Red"]
];
